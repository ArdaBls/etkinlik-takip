...
Uygulama açıldığında Firebase verisi yerel önbelleğin üzerine yazılır; Firebase'de silinen kayıtlar tekrar oluşturulmaz. Etkinlik, çocuk evi ve profil yolları Realtime Database canlı dinleyicileriyle izlenir. Kural dosyası veya admin e-postası değiştirildikten sonra ilgili kuralları Firebase Console'da yayımlayın.
